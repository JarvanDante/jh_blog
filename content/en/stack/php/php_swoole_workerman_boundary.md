---
author: "jarvan"
title: "Swoole/Workerman 在业务系统中的边界：什么时候该用，什么时候不该用"
date: 2020-12-15T10:00:00+08:00
description: "Swoole/Workerman 在业务系统中的边界：什么时候该用，什么时候不该用"
draft: false
hideToc: false
enableToc: true
...
这篇我只讲结论：Swoole/Workerman 很强，但不是所有 PHP 项目都值得上。
...
先把 FPM 架构下的 SQL、缓存、异步问题优化到位，再评估是否需要引入常驻进程模型。否则只是换一种方式背锅。
