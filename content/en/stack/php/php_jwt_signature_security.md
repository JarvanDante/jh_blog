---
author: "jarvan"
title: "PHP 安全进阶：JWT、签名、防重放与接口风控"
date: 2020-10-16T10:00:00+08:00
description: "PHP 安全进阶：JWT、签名、防重放与接口风控"
draft: false
hideToc: false
enableToc: true
...
接口安全如果只做 JWT，远远不够。我现在默认四件套：JWT + 时间戳签名 + nonce + 风控规则。

## 基础层

- JWT 短时效 access token
- refresh token 可吊销

## 请求防重放

签名串包含：`method + path + body + ts + nonce`
