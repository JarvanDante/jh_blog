---
author: "jarvan"
title: "从单体 Laravel 到领域拆分：可演进架构实践"
date: 2020-09-16T10:00:00+08:00
description: "从单体 Laravel 到领域拆分：可演进架构实践"
draft: false
hideToc: false
enableToc: true
...
我并不建议“推倒重写”。Laravel 单体改造最稳的方式是分层解耦，再按域拆服务。

## 迁移路线

1. Controller 瘦身，逻辑下沉到 Application Service
2. 仓储层抽象，隔离 ORM 细节
3. 模块按领域拆目录（user/order/payment）
4. 对外接口收口到 API Gateway
...
每次拆分都保留旧接口兼容层，出现异常可快速切回。

## 经验

最难的不是代码，是“历史耦合关系”。先画依赖图，后动刀，效率高很多。
